   ...
   // static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            startActivity(views,context,appWidgetManager,appWidgetId);
        }
    ...
    public  void startActivity(RemoteViews views , Context context , AppWidgetManager appWidgetManager, int appWidgetId){
        ...
        try {
          ...
          //      @Override
           ...
           if(isConnected){
               Toast.makeText(context,"目前不需要认证！",Toast.LENGTH_SHORT).show();
               isConnected = false;
           }
        }catch (Exception e){
            e.printStackTrace();
